...
<html lang="en"> 
<head>
    <title>La vraie Ecole :  <?php echo $this->uri->segment(2); ?></title>
...
<body>
    ...
    <header class="header text-center">     
        <h1 class="blog-name pt-lg-4 mb-0"><a href="<?php echo base_url() ?>">La Vraie Ecole 
        </a></h1>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark" >
            ...
            <div id="navigation" class="collapse navbar-collapse flex-column" >
                <div class="profile-section pt-3 pt-lg-0">
                    <img class="profile-image mb-3  mx-auto img-circle" src="<?php echo base_url() ?>assets/images/profile.png" alt="image" >            
                    
                    <div class="bio mb-3">Salut, Mon nom c'est Heritier NK. Je vous souhaite la bienvenue sur mon site. Ici vous pouvez apprendre des autres et apprendre aux autres.<br><a href="about.html">Decouvrez plus</a></div> <!--//bio-->
